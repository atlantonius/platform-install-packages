...
echo kaltura-base    kaltura-base/kaltura_mysql_passwd       password        @DB1_PASS@ | debconf-set-selections
echo kaltura-base    kaltura-base/kaltura_mysql_passwd_again password        @DB1_PASS@ | debconf-set-selections
